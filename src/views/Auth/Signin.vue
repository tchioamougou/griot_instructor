      ...
      <div class="relative flex flex-col justify-center w-full h-screen lg:flex-row dark:bg-gray-900">
                  ...
                  <div class="space-y-5">
                    ...
                    <div>
                      <label for="email" class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                        {{ $t('signIn.email') }}<span class="text-error-500">*</span>
                      </label>
                    ...
                    <div>
                      <label for="password" class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                        {{ $t('signIn.password') }}<span class="text-error-500">*</span>
                      </label>
                      <div class="relative">
        ...
        <div class="relative items-center hidden w-full h-full lg:w-1/2 bg-purple-900 dark:bg-white/5 lg:grid">
          <div class="flex items-center justify-center z-1">
            ...
            <img src="@/assets/images/header/undraw_secure-login_m11a.svg" alt="Background"
...
const validateEmail = (value: string | undefined): boolean => {
  if (value) {
    ...
    if (regex.test(value)) {
      ...
      error.value = "invalid_email_address"
      return false
    }
  } else {
    error.value = "please_enter_an_email_address"
    return false
  }
}
...
const validatePassword = (value: string | undefined): boolean => {
  if (value) {
    ...
    error.value = "please_enter_a_Password"
    return false
  }
}
const login = async () => {
  ...
  const checkPass = validatePassword(password.value)
    ...
    try {
      ...
      switch (error.code) {
        case "auth/user-not-found":
          error.value = "login_no_user_found"
          break
