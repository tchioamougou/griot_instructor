...
<script>
import {formatDateT, getFirstAndLastChars} from "../../../resources/UtilityFunction";
...
export default {
  ...
  computed:{
    avatar(){
     return  getFirstAndLastChars(this.enrollment.ownerId.name).toUpperCase();
    },
    enDate(){
      return formatDateT(this.enrollment.createdDate);
    }
  }
}
</script>
