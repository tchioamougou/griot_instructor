    ...
    <div class="g-students">
      <div class="header">
        <div class="header_title">
          ...
          <div class="input">
            <g-dropdown :options="courseOptions" label-class="large" @selected="findStudent" :disabled="isLoading" />
          </div>
        </div>
      </div>
      ...
      <template v-else>
        ...
        <div class="students_list">
          <div class="title">{{ $t("meet_people") }}</div>
          <div class="list">
...
import { getInstructorCourses, getStudents } from "@/services/griot_service";
...
import GStudentCarousel from "@/views/performance/GStudentCaroussel.vue";
...
const getInstructorCoursesLocal = () => {
  ...
  getInstructorCourses(user.value.id)
    ...
    .then((result) => {
      ...
      getStudentsLocal(allCourseId.value);
...
const getStudentsLocal = (request:any) => {
  isLoading.value = true;
  getStudents(request)
    .then((response) => {
      return response.json();
...
const findStudent = (val:any) => {
  console.log(val);
  if (val === "AllCourse") {
    getStudentsLocal(allCourseId.value);
  } else {
    getStudentsLocal([val]);
  }
};
const initGlobe = () => {
  am5.ready(function () {
    ...
    console.log("color data", colors.getIndex(0));
    ...
    const data = [
      ...
      },
      {
        ...
        name: "Albania",
        value: 3215988,
        polygonTemplate: { fill: colors.getIndex(8) },
      },
      {
        id: "DZ",
        name: "Algeria",
        value: 35980193,
        polygonTemplate: { fill: colors.getIndex(2) },
      },
      {
        id: "AO",
        name: "Angola",
      ...
      },
      {
        ...
        name: "Argentina",
        value: 40764561,
        polygonTemplate: { fill: colors.getIndex(3) },
      },
      {
        id: "AM",
        name: "Armenia",
      ...
      },
      {
        ...
        name: "Canada",
        value: 34349561,
        polygonTemplate: { fill: colors.getIndex(4) },
      },
      {
        id: "CV",
        name: "Cape Verde",
      ...
      },
      {
        ...
        name: "Senegal",
        value: 0,
        polygonTemplate: { fill: colors.getIndex(5) },
      },
      {
        id: "RS",
        name: "Serbia",
    ...
    polygonSeries.events.on("datavalidated", function () {
      ...
      for (let i  = 0; i < data.length; i++) {
        ...
        const countryDataItem:any = polygonSeries.getDataItemById(dataContext.id);
        ...
        if (countryPolygon) {
          const geometry = am5map.getGeoCircle(
